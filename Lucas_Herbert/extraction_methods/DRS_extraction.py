...
ancho_list = ['11_flat_edge'] #['0_flat_edge','5_flat_edge','8_flat_edge','11_flat_edge','11_divided_by_flat'] #'3','5','8','15_flat_edge'
...
for ancho_str in ancho_list :
	...
	for orden in range(0,36) :
		...
		# fout = open("extraction_methods/Extraction_files/temp/x0thar_ancho0_order_"+str(orden),'w')
		# pickle.dump(thar_result[0],fout)
		# fout.close()
		# fout = open("extraction_methods/Extraction_files/temp/x0flat_ancho0_order_"+str(orden),'w')
		# pickle.dump(flat_result[0],fout)
		# fout.close()
...
# 
# f = open("extraction_methods/Extraction_files/Matrices_Martin/Bmat_test_psf_ord14_lane1.npz",'r')
