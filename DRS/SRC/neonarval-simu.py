...
def main():
    for decal_y in [0]:
        ...
        # Le dark est de taille narval donc il n'est pas compatible
        # avec la neo-narval. On pourrait imaginer dans le futur faire
        # quelque chose du style un dark artificiel de la bonne
        # taille.
