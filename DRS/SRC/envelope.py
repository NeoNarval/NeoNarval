...
def Ref_localisation(fichier,nb_voie=2):
	...
	nb_order_left=6  				# the number of order we want beforer the brighter order
	central_row_index=lenX/2		# the index of the central rox
...
def Run(nb_voie=2):
	...
	flats10=find_10flats(path_files10)
	...
	while (len(flats10)!=0):
		...
		directory_path=find_path(path_file,"TEMP")
